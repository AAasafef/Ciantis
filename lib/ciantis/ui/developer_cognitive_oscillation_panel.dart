...
class DeveloperCognitiveOscillationPanel extends StatefulWidget {
  const DeveloperCognitiveOscillationPanel({super.key});

  @override
  State<DeveloperCognitiveOscillationPanel> createState() =>
      _DeveloperCognitiveOscillationPanelState();
}

class _DeveloperCognitiveOscillationPanelState
    extends State<DeveloperCognitiveOscillationPanel>
  ...
  void _onOscillationTap(String label, double value) {
    DeveloperLogger.log(
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      child: Container(
        ...
        child: Column(
          children: _oscillationMetrics.map((metric) {
            final label = metric["label"] as String;
            final value = metric["value"] as double;
            final icon = metric["icon"] as IconData;

            return GestureDetector(
              onTap: () => _onOscillationTap(label, value),
              child: Container(
