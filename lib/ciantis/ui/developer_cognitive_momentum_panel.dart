...
class DeveloperCognitiveMomentumPanel extends StatefulWidget {
  const DeveloperCognitiveMomentumPanel({super.key});

  @override
  State<DeveloperCognitiveMomentumPanel> createState() =>
      _DeveloperCognitiveMomentumPanelState();
}

class _DeveloperCognitiveMomentumPanelState
    extends State<DeveloperCognitiveMomentumPanel>
  ...
  void _onMomentumTap(String label, double value) {
    DeveloperLogger.log(
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      child: Container(
        ...
        child: Column(
          children: _momentumMetrics.map((metric) {
            final label = metric["label"] as String;
            final value = metric["value"] as double;
            final icon = metric["icon"] as IconData;

            return GestureDetector(
              onTap: () => _onMomentumTap(label, value),
              child: Container(
