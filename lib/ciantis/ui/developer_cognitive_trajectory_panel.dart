...
class DeveloperCognitiveTrajectoryPanel extends StatefulWidget {
  const DeveloperCognitiveTrajectoryPanel({super.key});

  @override
  State<DeveloperCognitiveTrajectoryPanel> createState() =>
      _DeveloperCognitiveTrajectoryPanelState();
}

class _DeveloperCognitiveTrajectoryPanelState
    extends State<DeveloperCognitiveTrajectoryPanel>
  ...
  void _onTrajectoryTap(String label, double value) {
    DeveloperLogger.log(
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      child: Container(
        ...
        child: Column(
          children: _trajectoryMetrics.map((metric) {
            final label = metric["label"] as String;
            final value = metric["value"] as double;
            final icon = metric["icon"] as IconData;

            return GestureDetector(
              onTap: () => _onTrajectoryTap(label, value),
              child: Container(
