...
class DeveloperCognitiveAlignmentPanel extends StatefulWidget {
  const DeveloperCognitiveAlignmentPanel({super.key});

  @override
  State<DeveloperCognitiveAlignmentPanel> createState() =>
      _DeveloperCognitiveAlignmentPanelState();
}

class _DeveloperCognitiveAlignmentPanelState
    extends State<DeveloperCognitiveAlignmentPanel>
  ...
  void _onAlignmentTap(String label, double value) {
    DeveloperLogger.log(
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      child: Container(
        ...
        child: Column(
          children: _alignmentMetrics.map((metric) {
            final label = metric["label"] as String;
            final value = metric["value"] as double;
            final icon = metric["icon"] as IconData;

            return GestureDetector(
              onTap: () => _onAlignmentTap(label, value),
              child: Container(
