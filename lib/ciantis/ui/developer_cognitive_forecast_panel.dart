...
class DeveloperCognitiveForecastPanel extends StatefulWidget {
  const DeveloperCognitiveForecastPanel({super.key});

  @override
  State<DeveloperCognitiveForecastPanel> createState() =>
      _DeveloperCognitiveForecastPanelState();
}

class _DeveloperCognitiveForecastPanelState
    extends State<DeveloperCognitiveForecastPanel>
