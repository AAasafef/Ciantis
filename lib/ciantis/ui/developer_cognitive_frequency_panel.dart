...
class DeveloperCognitiveFrequencyPanel extends StatefulWidget {
  const DeveloperCognitiveFrequencyPanel({super.key});

  @override
  State<DeveloperCognitiveFrequencyPanel> createState() =>
      _DeveloperCognitiveFrequencyPanelState();
}

class _DeveloperCognitiveFrequencyPanelState
    extends State<DeveloperCognitiveFrequencyPanel>
  ...
  void _onFrequencyTap(String label, double value) {
    DeveloperLogger.log(
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      child: Container(
        ...
        child: Column(
          children: _frequencyMetrics.map((metric) {
            final label = metric["label"] as String;
            final value = metric["value"] as double;
            final icon = metric["icon"] as IconData;

            return GestureDetector(
              onTap: () => _onFrequencyTap(label, value),
              child: Container(
