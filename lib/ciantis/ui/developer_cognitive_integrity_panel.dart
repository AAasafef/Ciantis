...
class DeveloperCognitiveIntegrityPanel extends StatefulWidget {
  const DeveloperCognitiveIntegrityPanel({super.key});

  @override
  State<DeveloperCognitiveIntegrityPanel> createState() =>
      _DeveloperCognitiveIntegrityPanelState();
}

class _DeveloperCognitiveIntegrityPanelState
    extends State<DeveloperCognitiveIntegrityPanel>
  ...
  void _onIntegrityTap(String label, double value) {
    DeveloperLogger.log(
        ...
        child: Column(
          children: _integrityMetrics.map((metric) {
            ...
            return GestureDetector(
              onTap: () => _onIntegrityTap(label, value),
              child: Container(
