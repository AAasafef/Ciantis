...
class DeveloperCognitiveDriftPanel extends StatefulWidget {
  const DeveloperCognitiveDriftPanel({super.key});

  @override
  State<DeveloperCognitiveDriftPanel> createState() =>
      _DeveloperCognitiveDriftPanelState();
}

class _DeveloperCognitiveDriftPanelState
    extends State<DeveloperCognitiveDriftPanel>
  ...
  void _onDriftTap(String label, double value) {
    DeveloperLogger.log(
